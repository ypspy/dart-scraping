...
## 입수 데이터
아래 표에 위의 코드를 활용하여 입수한 Data를 다운로드 할 수 있는 링크가 포함되어 있다.
DART 공시자료의 특성상 정정공시가 될 때 정정전 공시가 포함된다.
이로 인하여 입수기간에 따라 중복정보가 입수될 수 있다는 점을 고려하여야 한다.
위의 입수파일명에서 입수 단위의 고유키를 조합(예: 법인등록번호+공시일+보고서명)할 수 있으니 중복은 제거 가능하다.

<표>
공시기간 | 입수기간 | A001 사업보고서 | A002 반기사업보고서 | A003 분기사업보고서 | F001 감사보고서 | F002 연결감사보고서 | F004 회계법인사업보고서
---|---|---|---|---|---|---|---
2020 | - | - | - | - | - | - | -
2019 | 2020.8.7-| - | - | - | - | - | [(download)](https://drive.google.com/file/d/1sL-EdtInL24NZFuwiEcV1FSJ3vLSnxsa/view?usp=sharing)
